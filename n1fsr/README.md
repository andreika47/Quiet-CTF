...
Будем рассматривать начальные состояния LFSR как неизвестные. Пусть начальные состояния LFSR без фильтра или с линейным фильтром - это переменные $x_1, ..., x_{32}, x_{33}, ..., x_{56}$. Для LFSR 3 с коротким циклом обозначим выходные состояния как $x_{57}, ..., x_{119}$. LFSR с одинаковой длиной цикла можно объекдинить в один LFSR. Его начальные состояния обозначим как $x_{120}, ..., x_{374}$. 
