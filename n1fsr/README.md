...
Будем рассматривать начальные состояния LFSR как неизвестные. Пусть начальные состояния LFSR без фильтра или с линейным фильтром - это переменные $x{1}, ..., x{32}, x{33}, ..., x{56}$. Для LFSR 3 с коротким циклом обозначим выходные состояния как $x{57}, ..., x{119}$. LFSR с одинаковой длиной цикла можно объекдинить в один LFSR. Его начальные состояния обозначим как $x{120}, ..., x{374}$. 
