...
Название и код задания намекают на криптосистему, основанную на группе Томпсона. Погуглив, можно наткнуться на статью, которая описываете теоритическую возможность реализации ассиметричной криптосистемы: https://www.researchgate.net/publication/227334937_Thompson's_Group_and_Public_Key_Cryptography<br>
**TLDR**:<br>
...
<br><br>
Погуглив еще можно найти статью, которая показывает что для данной криптосистемы задача декомпозиции не слишком и сложна: https://boa.unimib.it/retrieve/handle/10281/214402/309753/thompson-crypto-break5.pdf <br>
**TLDR**:<br>
