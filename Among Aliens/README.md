...
2. На диагонали выше главной диагонали стоят единицы<br>
Одним из главных свойств матрицы и ЖНФ является их подобие, поэтому из $J = B * A * B^{-1}$ следует, что $A = B * J * B^{-1}$<br>
