...
```
Подобное представление возмодно, так как в сумме (2) коэффициенты мономом по сути являются тензорным произведением $u{i} \otimes u{j} \otimes u{k}$ и соответствуют элементам тензора.
