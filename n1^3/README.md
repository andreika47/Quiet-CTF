...
`E(x) = F(x * U) * T`, где преобразование `F` - это возведение каждого элемента матрицы в куб.

**Быстрый разбор**
Нужно реализовать MinRank атаку из этой статьи https://eprint.iacr.org/2023/1535.pdf
